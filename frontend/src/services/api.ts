...
const API_BASE_URL="http://16.171.113.47:3001/api"
...
export const newCard=async(front:string|null,back:string|null,hint:string|null,tag:ReadonlyArray<string>):Promise<void>=>{
    const payload = { front, back, hint, tag };
    await apiClient.post("/createCard", payload);
}
